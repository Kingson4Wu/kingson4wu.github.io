...
type: post
slug: >-
  why-rust-requires-explicit-lifetime-annotations-caller-contracts-design-essence
description: >-
  Rust lifetime annotations are not just compiler hints. They are part of the
  function contract, which is why explicit lifetimes matter for callers, traits,
  and API stability.
...
source:
  repo: en
  path: >-
    src/content/blog/why-rust-requires-explicit-lifetime-annotations-from-caller-contracts-to-design-essence.md
---
