...
const inferenceRules: Array<{ tag: string; patterns: RegExp[] }> = [
  ...
  { tag: 'LLM', patterns: [/LLM|大模型|大语言模型|token|temperature|推理引擎/i] },
  { tag: 'Agent', patterns: [/agent|智能体|Agent Runtime/i] },
  { tag: 'Skill', patterns: [/skill|技能/i] },
  { tag: 'MHS', patterns: [/\bMHS\b|Model Hardware Standard/i] },
  ...
  { tag: 'Christianity', patterns: [/基督教|Christianity/i] },
  { tag: 'Religion', patterns: [/宗教|基督教|犹太教|伊斯兰教|上帝|圣经|耶稣/i] },
  { tag: 'History', patterns: [/历史|欧洲史|罗马帝国|宗教改革|时间线/i] },
...
function expandRelatedTags(tags: Set<string>): void {
  if (hasAny(tags, ['LLM', 'Agent', 'Skill', 'MCP', 'RAG', 'Prompt Engineering'])) {
    tags.add('AI');
  }
