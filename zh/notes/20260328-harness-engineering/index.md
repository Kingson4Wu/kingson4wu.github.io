...
Canonical: https://kingson4wu.github.io/zh/notes/20260328-harness-engineering/
Markdown: https://kingson4wu.github.io/zh/notes/20260328-harness-engineering/index.md
Language: zh
Type: note
Date: 2026-03-28
Tags: AI, LLM, MCP, Prompt Engineering

LLM 只做一件事：给定输入，生成输出。 模型是固定的。你能控制的，其实只有输入，以及围绕输入输出构建的系统。 由此派生出两个真实的工程问题域。 问题域 A：如何构造更好的输入 这是一个连续的复杂度谱系： 手工写指令 -&gt; Prompt Engineering 动态检索、拼装、压缩信息 -&gt; Context...
