...
Canonical: https://kingson4wu.github.io/zh/posts/20140302/
Markdown: https://kingson4wu.github.io/zh/posts/20140302/index.md
Language: zh
Type: post
Date: 2014-03-02
Tags: Reading, Career

专业主义的精髓就在于将公司的利益视同个人的利益。 不能忽略完整的测试环节，否则就交付软件是不负责任的。 为自己的不完美负责。代码难免出现bug，但这并不意味着你不用对它们负责。 让QA找不出任何问题。把自己没把握的代码发送给QA是不专业的，违背了“不行损害之事”的原则。 有些代码很难测试，是因为设计时就没考虑如何测试。...
