...
Canonical: https://kingson4wu.github.io/zh/posts/20200705/
Markdown: https://kingson4wu.github.io/zh/posts/20200705/index.md
Language: zh
Type: post
Date: 2020-07-05
Tags: Architecture, Distributed Systems, Database

图：MSN 在平常编码的时候，经常会看到很多人喜欢把一次RPC调用和数据库事务绑定在一起，RPC调用成功则提交事务，RPC调用失败或超时，则回滚事务。那么这样做是对的吗？ 业务场景描述 考虑以下一种业务场景：用户加入群聊需要花费200金币。 服务架构：服务A(群服务)，服务B(消费服务)，操作都是幂等的。 加群请求--...
