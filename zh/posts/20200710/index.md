...
Canonical: https://kingson4wu.github.io/zh/posts/20200710/
Markdown: https://kingson4wu.github.io/zh/posts/20200710/index.md
Language: zh
Type: post
Date: 2020-07-10
Tags: Architecture, Database

缓存的三座大山 以下内容摘自：翻越缓存的三座大山 缓存一致性 缓存一致性是指业务在引入分布式缓存系统后，业务对数据的更新除了要更新存储以外还需要同时更新缓存，对两个系统进行数据更新就要先解决分布式系统中的隔离性和原子性难题。 缓存击穿 缓存击穿是指查询请求没有在缓存层命中而将查询透传到存储 DB 的问题，当大量的请求发...
