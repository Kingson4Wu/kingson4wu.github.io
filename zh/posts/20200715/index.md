...
Canonical: https://kingson4wu.github.io/zh/posts/20200715/
Markdown: https://kingson4wu.github.io/zh/posts/20200715/index.md
Language: zh
Type: post
Date: 2020-07-15
Tags: Database

前言 本文只讲自己在使用canal之后的一些总结，关于canal的基础用法和介绍，不在这里赘述。 原理 canal的原理是基于mysql binlog技术，所以这里一定需要开启mysql的binlog写入功能，建议配置binlog模式为row 原文：https://blog.csdn.net/liupeifeng351...
