...
Canonical: https://kingson4wu.github.io/zh/posts/20200804/
Markdown: https://kingson4wu.github.io/zh/posts/20200804/index.md
Language: zh
Type: post
Date: 2020-08-03
Tags: Architecture, Finance

在打赏类业务中，消费跟分成是紧紧挂钩的。比如在直播间送礼，用户通过花费虚拟货币给对方送礼，而对方则得到相应的分成。 定义：用户花费的是“金币”，接受者得到的是“银币”。 设计概要 一、用户货币类型组成 用户通过充值或活动赠币等方式得到“金币(coin)” 充值行为得到的是“充值金币(money)” 活动赠币等非充值行为...
