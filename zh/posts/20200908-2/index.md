...
Canonical: https://kingson4wu.github.io/zh/posts/20200908-2/
Markdown: https://kingson4wu.github.io/zh/posts/20200908-2/index.md
Language: zh
Type: post
Date: 2020-09-08
Tags: Reliability, Finance

前言 接关于MHA_Consul_MySQL高可用方案的简单总结和思考 中所讲，该方案无法严格保证主从数据一致或者不丢数据，那么对数据准确性非常严格的业务，则需要在业务层面进行相应的对账和修正。 对账的前提当然是要有流水，可以是业务流水(跟余额表事务绑定)或者是binlog的变更流水。 既然是对准确性要求严格的业务，一...
