...
Canonical: https://kingson4wu.github.io/zh/posts/20200908/
Markdown: https://kingson4wu.github.io/zh/posts/20200908/index.md
Language: zh
Type: post
Date: 2020-09-07
Tags: Reliability, Finance

概述 本文针对金融类(如用户虚拟货币)这类对数据准确性很敏感的业务的容灾架构； 案例中的服务架构为同城主备架构； 内容包括：容灾架构、故障切换、故障恢复、演练方案等； 涉及技术点：MySQL、MHA、Consul等； 本文基于 关于MHA-Consul-MySQL高可用方案的简单总结和思考 如何解决脑裂问题 由于某种原...
