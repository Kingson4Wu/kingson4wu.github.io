...
Canonical: https://kingson4wu.github.io/zh/posts/20200926/
Markdown: https://kingson4wu.github.io/zh/posts/20200926/index.md
Language: zh
Type: post
Date: 2020-09-26
Tags: Networking

图：TCP三次握手四次挥手 图：tcp normal close ESTABLISHED 表示正在进行网络连接的数量 TIME_WAIT 表示表示等待系统主动关闭网络连接的数量 CLOSE_WAIT 表示被动等待程序关闭的网络连接数量 查看系统TCP状态的命令：netstat -n | awk '/^tcp/ {++S...
