...
整体架构 图来源：k8s-整体概述和架构 关键名词 CNCF（Cloud Native Computing Foundation，云原生计算基金会） 关键总结 自动化 Docker是其目前支持的底层容器技术之一 服务弹性扩容机制应对突发流量 Kubernetes视为云计算时代的操作系统 k8s解决进程（服务）部署、容器...
