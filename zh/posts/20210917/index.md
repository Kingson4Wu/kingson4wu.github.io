...
Canonical: https://kingson4wu.github.io/zh/posts/20210917/
Markdown: https://kingson4wu.github.io/zh/posts/20210917/index.md
Language: zh
Type: post
Date: 2021-09-17
Tags: Architecture

最近公司出现跨机房调用redis超时导致的故障，借此简单记录一下微服务依赖的相关组件使用规范。 Redis 每个服务的每个IDC对应一套Redis集群，原则上： 不同服务不共用一套redis：避免业务相互影响，key定义冲突等问题； 不跨机房读写redis：避免不必要的时延等 同个服务不同IDC的redis数据怎么同步...
