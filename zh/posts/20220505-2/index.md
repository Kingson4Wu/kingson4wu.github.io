...
Canonical: https://kingson4wu.github.io/zh/posts/20220505-2/
Markdown: https://kingson4wu.github.io/zh/posts/20220505-2/index.md
Language: zh
Type: post
Date: 2022-05-05
Tags: Networking, Media

RTMP 协议:https://www.jianshu.com/p/d511d59b185c RTMP、RTSP、HTTP视频协议详解（附：直播流地址、播放软件）:https://www.hangge.com/blog/cache/detail_1325.html RTMP、HTTP-FLV、HLS，你了解常见的三大直...
...
+ WebRTC：名称源自网页即时通信（Web Real-Time Communication）的缩写，是一组支持浏览器进行实时音视频通信的标准与 API。WebRTC 项目在 2011 年由 Google 开源推动，相关标准后来由 W3C 和 IETF 持续推进，其中 WebRTC 1.0 在 2021 年成为 W3C Recommendation。快直播正是用的 WebRTC 协议，它是标准直播在超低延迟播放场景下的延伸，比传统直播协议延迟更低，能够满足一些对延迟性能要求更高的特定场景需求，例如在线教育、体育赛事直播、在线答题等。
