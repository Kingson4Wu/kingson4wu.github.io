...
Canonical: https://kingson4wu.github.io/zh/posts/20220505/
Markdown: https://kingson4wu.github.io/zh/posts/20220505/index.md
Language: zh
Type: post
Date: 2022-05-05
Tags: Media

图片拼接成特效视频 FFmpeg MediaCodec OpenGL JavaCV JavaCV是对各种常用计算机视觉库的封装后的一组jar包，其中封装了ffmpeg、OpenCV、libdc1394、OpenKinect、videoInput和ARToolKitPlus等计算机视觉编程人员常用库的接口，可以通过其中的...
