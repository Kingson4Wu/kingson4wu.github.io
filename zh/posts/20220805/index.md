...
Canonical: https://kingson4wu.github.io/zh/posts/20220805/
Markdown: https://kingson4wu.github.io/zh/posts/20220805/index.md
Language: zh
Type: post
Date: 2022-08-05
Tags: Networking

概述 从客户端是手机APP的角度来理解推送（PUSH），展示的形式有两种： App 推送：消息内容通过手机通知栏（状态栏）展示 应用内消息：各种业务数据推送（通过定义模版或命令号等方式推送给APP内的业务使用） 从Web端角度看理解推送，一般只有网页内消息（跟手机APP的应用内消息是一样的类型） APP推送： 在线推送...
