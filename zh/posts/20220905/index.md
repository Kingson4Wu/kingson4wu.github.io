...
Canonical: https://kingson4wu.github.io/zh/posts/20220905/
Markdown: https://kingson4wu.github.io/zh/posts/20220905/index.md
Language: zh
Type: post
Date: 2022-09-05
Tags: Networking

粗浅概括 HTTP - TCP HTTPS - TCP + TLS SPDY -&gt; TCP + TLS + 多路复用、头部压缩等特性 --&gt; 发展成 HTTP/2 SPDY是Speedy的音，是更快的意思 HTTP/2 - TCP + TLS(理论上可选) + 多路复用、头部压缩等特性 QUIC - UDP...
