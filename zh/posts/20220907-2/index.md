...
Canonical: https://kingson4wu.github.io/zh/posts/20220907-2/
Markdown: https://kingson4wu.github.io/zh/posts/20220907-2/index.md
Language: zh
Type: post
Date: 2022-09-07
Tags: Networking

有接触过TCP服务器实现的同学都会知道，需要注意TCP_NODELAY参数，为什么呢？ 若没有开启TCP_NODELAY，那么在发送小包的时候，可能会出现这样的现象： 通过 TCP socket 分多次发送较少的数据时，比如小于 1460 或者 100 以内，对端可能会很长时间收不到数据，导致本端应用程序认为超时报错。...
