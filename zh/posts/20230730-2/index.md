...
Canonical: https://kingson4wu.github.io/zh/posts/20230730-2/
Markdown: https://kingson4wu.github.io/zh/posts/20230730-2/index.md
Language: zh
Type: post
Date: 2023-07-30
Tags: Networking

结论先行 服务死锁导致大量请求hang住，进程无法提供服务且大量socket泄漏 具体过程 服务某些逻辑处理不当导致死锁 大量请求hang住没有响应 上层的nginx超时主动关闭连接 服务被关闭连接，导致大量CLOSE_WAIT 由于服务对连接处理不当（待分析原因TODO），导致大量socket泄漏 前置知识 TCP状...
