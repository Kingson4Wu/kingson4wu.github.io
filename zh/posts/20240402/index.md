...
Canonical: https://kingson4wu.github.io/zh/posts/20240402/
Markdown: https://kingson4wu.github.io/zh/posts/20240402/index.md
Language: zh
Type: post
Date: 2024-04-02
Tags: Security

最近的工作原因，涉及到接口充权益的接口安全性问题，这里趁热再说说个人看法 基于之前写的这篇使用回调机制提高接口安全性继续聊。上次扩展中提到是不是可以使用非对称加密，替换回调验证？目前我所负责的业务确实使用这种方式。 业务中要对接多个渠道，渠道需要调业务的接口来加权益，为了安全性，目前的做法是由渠道自己生成RSA私钥，提...
