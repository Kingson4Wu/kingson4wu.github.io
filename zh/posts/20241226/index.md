...
Canonical: https://kingson4wu.github.io/zh/posts/20241226/
Markdown: https://kingson4wu.github.io/zh/posts/20241226/index.md
Language: zh
Type: post
Date: 2024-12-26
Tags: AI, LLM

以下内容基本都是从书籍中摘抄，用于个人记录 从AI得出的回答不一定正确或者只是现阶段暂时正确 增加部分个人理解 LLM（Large Language Model） 大语言模型的涌现能力被非形式化定义为“在小型模型中不存在但在大模型中出现的能力”，具体是指当模型扩展到一定规模时，模型的特定任务性能突然出现显著跃升的趋势，...
...
+ 提示工程能够优化 AI 对话输出的原理主要基于以下几个关键方面：
...
+ 指令微调(Instruction Tuning/RLHF)和Fine-tuning虽然都是大模型调优的方法，但它们是不同的技术：
    - Fine-tuning:
