...
Canonical: https://kingson4wu.github.io/zh/posts/20250817-http-tcp/
Markdown: https://kingson4wu.github.io/zh/posts/20250817-http-tcp/index.md
Language: zh
Type: post
Date: 2025-08-16
Tags: Networking

发现之前的理解有一点小偏差，重新整理一下 以前我对正向代理和反向代理的理解有点混在一起，尤其是 HTTP 请求行、Host 头和 TCP 连接目标之间的关系。这里重新整理一下。 简单说：TCP 只知道连哪个 IP 和端口；代理语义是在 HTTP 层和客户端实现里体现的。 1. 正向代理（Forward Proxy） 使...

---

>> 发现之前的理解有一点小偏差，重新整理一下

以前我对正向代理和反向代理的理解有点混在一起，尤其是 HTTP 请求行、Host 头和 TCP 连接目标之间的关系。这里重新整理一下。

简单说：TCP 只知道连哪个 IP 和端口；代理语义是在 HTTP 层和客户端实现里体现的。
