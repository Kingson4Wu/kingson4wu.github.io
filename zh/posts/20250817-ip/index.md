...
Canonical: https://kingson4wu.github.io/zh/posts/20250817-ip/
Markdown: https://kingson4wu.github.io/zh/posts/20250817-ip/index.md
Language: zh
Type: post
Date: 2025-08-17
Tags: Networking

家庭宽带里经常会遇到一个问题：我家到底有没有独立公网 IP？ 这个问题会直接影响端口映射、P2P、家庭服务器、远程访问等场景。这里简单整理一下家庭宽带常见的 IP 分配方式，以及 CGNAT 对实际使用的影响。 1. 家庭宽带的几种典型 IP 分配方式 （1）独立公网 IP 家庭路由器的 WAN 口直接获取公网 IPv...

---

家庭宽带里经常会遇到一个问题：我家到底有没有独立公网 IP？

这个问题会直接影响端口映射、P2P、家庭服务器、远程访问等场景。这里简单整理一下家庭宽带常见的 IP 分配方式，以及 CGNAT 对实际使用的影响。
