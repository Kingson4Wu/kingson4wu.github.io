...
Canonical: https://kingson4wu.github.io/zh/posts/20250817-socks5/
Markdown: https://kingson4wu.github.io/zh/posts/20250817-socks5/index.md
Language: zh
Type: post
Date: 2025-08-17
Tags: Networking

SOCKS5 是一种常见的正向代理协议。它和 HTTP 代理最大的区别是：它不关心上层到底是 HTTP、SSH、DNS 还是别的协议，核心工作就是帮客户端转发 TCP/UDP 数据。 这里简单整理一下 SOCKS5 的流程和几个容易混淆的点。 1. 正向代理的基本概念 正向代理是指客户端主动使用代理服务器，把请求先发给...

---

SOCKS5 是一种常见的正向代理协议。它和 HTTP 代理最大的区别是：它不关心上层到底是 HTTP、SSH、DNS 还是别的协议，核心工作就是帮客户端转发 TCP/UDP 数据。

这里简单整理一下 SOCKS5 的流程和几个容易混淆的点。
