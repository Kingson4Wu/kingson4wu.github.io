# 用脚本+AI CLI半自动写代码：实践经验分享

Canonical: https://kingson4wu.github.io/zh/posts/20250902-ai/
Markdown: https://kingson4wu.github.io/zh/posts/20250902-ai/index.md
Language: zh
Type: post
Date: 2025-09-02
Tags: AI, Prompt Engineering, Python, Programming Languages

最近在折腾一个“半自动编程”项目，目标是让 AI 工具在一个相对可控的框架下持续编码，帮我实现一个个明确的开发任务。这里分享整个过程、思路和实践套路，算是一次探索性的工程笔记。 为什么要搞半自动 市面上的 AI 编程工具越来越多，比如：Claude Code、Gemini CLI、QWEN CODE 以及其他支持 CL...
...
## 扩展
+ [AGENTS.md](https://agents.md/): Think of AGENTS.md as a README for agents
+ 细化任务方案，可以参考[spec-kit](https://github.com/github/spec-kit) 或 [OpenSpec](https://github.com/Fission-AI/OpenSpec)的套路
