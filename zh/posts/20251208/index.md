...
Canonical: https://kingson4wu.github.io/zh/posts/20251208/
Markdown: https://kingson4wu.github.io/zh/posts/20251208/index.md
Language: zh
Type: post
Date: 2025-12-08
Tags: AI, LLM, Architecture

以下内容有ChatGPT和Claude.ai辅助生成 生成式AI、解码约束与多模态架构：系统化原理解析 大语言模型从单纯的文本生成发展到多模态理解、结构化输出、工具调用等复杂能力,让许多人好奇:这些模型是否真的具备“理解”和“推理”能力?本文将系统梳理从基础生成原理到多模态融合、从解码器约束到专家混合(MoE)架构的完...
