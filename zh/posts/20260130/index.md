...
Canonical: https://kingson4wu.github.io/zh/posts/20260130/
Markdown: https://kingson4wu.github.io/zh/posts/20260130/index.md
Language: zh
Type: post
Date: 2026-01-30
Tags: AI, LLM, Deep Learning, Math

——从函数形式到分段线性逼近的机制说明 一、感知机与神经网络的基本函数形式 在深度学习中，感知机及其扩展的神经网络，并不是在使用人为指定的多项式函数形式，例如： y=x12+x22+x33y = x_1^2 + x_2^2 + x_3^3y=x12​+x22​+x33​ 其基本计算结构为： y=f(w1x1+w2x2+...
