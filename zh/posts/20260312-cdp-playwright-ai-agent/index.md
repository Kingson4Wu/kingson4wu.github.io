...
Canonical: https://kingson4wu.github.io/zh/posts/20260312-cdp-playwright-ai-agent/
Markdown: https://kingson4wu.github.io/zh/posts/20260312-cdp-playwright-ai-agent/index.md
Language: zh
Type: post
Date: 2026-03-12
Tags: AI, LLM, Agent, Skill, MCP

系统梳理 CDP、Playwright、视觉自动化与 AI Agent 在浏览器自动化体系中的分层关系与适用边界。

---

浏览器自动化这几年变得越来越重要，原因不只是自动化测试，还包括 AI Agent、自动化运营、数据抓取等场景。相关技术路线很多，例如：
...
LLM Agent 开始进入浏览器操作场景后，一些工具专门为 AI 提供浏览器接口，例如 **agent-browser、browser-use**。这类工具并不是新的浏览器技术，而是 **AI 适配层**，核心思想是：
