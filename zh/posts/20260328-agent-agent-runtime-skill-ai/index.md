...
Canonical: https://kingson4wu.github.io/zh/posts/20260328-agent-agent-runtime-skill-ai/
Markdown: https://kingson4wu.github.io/zh/posts/20260328-agent-agent-runtime-skill-ai/index.md
Language: zh
Type: post
Date: 2026-03-28
Tags: AI, LLM, Agent, Skill, MCP

从系统分层视角梳理 AI 应用从自建 Agent 走向 Runtime 与 Skill 组合架构的演进逻辑。
...
Skill 的本质是**可执行的知识（Executable Knowledge）**：
