# Dense + Sparse：从信息表示、RAG 检索到 LLM 架构的统一理解

Canonical: https://kingson4wu.github.io/zh/posts/20260730-dense-sparse-rag-llm/
Markdown: https://kingson4wu.github.io/zh/posts/20260730-dense-sparse-rag-llm/index.md
Language: zh
Type: post
Date: 2026-07-30
Tags: AI, LLM, RAG, Deep Learning

从信息表示、RAG 检索、MoE、Sparse Attention 和推理计算几个角度，理解 Dense 与 Sparse 在现代 AI 系统里的统一思想。
